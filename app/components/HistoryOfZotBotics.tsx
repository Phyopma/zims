...
export default function HistoryOfZotBotics() {
  const timelineData = [
    { year: "2020", description: "ZOTBotics Founded" },
    { year: "2021", description: "First competition" },
    { year: "2022", description: "New robot model" },
    { year: "2023", description: "Expansion to schools" },
    { year: "2024", description: "National championship" },
  ];

  return (
    <div className="py-6">
      <div className="text-center font-display text-6xl">
        History of ZotBotics
      </div>
      <ul className="timeline">
